...
def trainCBMNet_flowx4_BSERGB(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"{args.model_name}_tuning_x4adamw" + f"{args.extension}")
    ...
    training_config.optim.scheduler_params.milestones = [36]
