...
def traintest_BSERGB_x2_quick_largerlr(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"_{args.model_name}_largerlrquick" + f"_full{args.extension}")
    ...
    training_config.crop_size = 448 if hostname == 'server' else 64
    ...
    training_config.optim.scheduler_params.T_max = 125000
