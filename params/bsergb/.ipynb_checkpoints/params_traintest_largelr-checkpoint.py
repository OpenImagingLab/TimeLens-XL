...
def traintest_BSERGB_x2_llr(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"_{args.model_name}" + f"_llr{args.extension}")
    ...
    training_config.optim.scheduler_params.T_max = 260000
