...
def traintest_BSERGB_x2_REFID(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"_{args.model_name}" + f"_full{args.extension}")
    ...
    training_config = ED()
    training_config.dataloader = 'loader_bsergb_REFID'
    ...
    validation_config.dataloader = 'loader_bsergb_REFID'
    ...
    validation_config.real_interp = 2
