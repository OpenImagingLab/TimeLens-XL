...
def traintest_BSERGB_x2_halfhalftest(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"_{args.model_name}" + f"_adamHalfLPIPSHalfChar{args.extension}")
    ...
    training_config.losses.HalfCharbonier = ED()
    training_config.losses.HalfCharbonier.weight = 1.
    training_config.losses.HalfCharbonier.as_loss = True

    training_config.losses.halflpips = ED()
    training_config.losses.halflpips.weight = 0.1
    training_config.losses.halflpips.as_loss = True
    ...
    validation_config.losses.psnr.scale = 0.5
    ...
    validation_config.losses.ssim.scale = 0.5
