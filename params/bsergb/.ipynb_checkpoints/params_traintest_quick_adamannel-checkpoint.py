...
def traintest_BSERGB_x2Anneal(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"_{args.model_name}" + f"_adamAneal{args.extension}")
    ...
    training_config.losses = ED()
    training_config.losses.AnnealCharbonier = ED()
    training_config.losses.AnnealCharbonier.weight = 1.
    training_config.losses.AnnealCharbonier.as_loss = True
    training_config.losses.AnnealCharbonier.fact = 0.8
