...
def traintest_BSERGB_x4AdamwithLPIPS_iter(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"iter_{args.model_name}" + f"_x4adamwithLPIPS{args.extension}")
