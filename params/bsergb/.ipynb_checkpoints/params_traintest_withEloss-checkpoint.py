...
def traintest_BSERGB_x2_ELoss(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"_{args.model_name}" + f"_withEloss_{args.extension}")
    ...
    training_config.crop_size = 480 if hostname == 'server' else 64
    ...
    training_config.losses.ECharbonier = ED()
    training_config.losses.ECharbonier.weight = 1.
    training_config.losses.ECharbonier.as_loss = True
    training_config.losses.ECharbonier.emask_type = 'sum'
