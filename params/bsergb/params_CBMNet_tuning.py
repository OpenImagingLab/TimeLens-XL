...
def trainCBMNet_tuning_BSERGB(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"{args.model_name}_tuning_adamw" + f"{args.extension}")
    ...
    training_config.optim.scheduler_params.milestones = [36, 63]
    ...
    validation_config.val_imsave_epochs = 9
    ...
    validation_config.interp_ratio = 2
