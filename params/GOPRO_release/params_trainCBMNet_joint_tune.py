...
def GOPRO_release_CBMNet_joint_tune(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, 'GOPROTune'+f"_{args.model_name}_joint" + f"{args.extension}")
    ...
    training_config.optim.scheduler_params.milestones = [37]
    ...
    params.pretrain_weights_dict = {
        'FlowNet': './RGB_GOPRO_release/GOPRO_myCBMNet_flow/weights/myCBMNet_40.pt'
    }
    params.training_stage = 'joint'
    params.gpu_num = 2
    return params
