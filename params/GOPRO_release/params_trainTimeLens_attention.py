...
def GOPRO_release_TimeLens_attention(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, 'GOPRO'+f"_{args.model_name}_attention" + f"{args.extension}")
    ...
    params.training_stage = 'attention'
    params.pretrain_weights_dict = {
        'flow_network': './RGB_GOPRO_release/GOPRO_TimeLens_flow/weights/TimeLens_27.pt',
        'fusion_network': './RGB_GOPRO_release/GOPRO_TimeLens_fusion/weights/TimeLens_27.pt',
        'flow_refinement_network': './RGB_GOPRO_release/GOPRO_TimeLens_refine/weights/TimeLens_27.pt'
    }
    return params
