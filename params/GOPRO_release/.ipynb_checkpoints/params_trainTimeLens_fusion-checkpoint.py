...
def GOPRO_release_TimeLens_fusion(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, 'GOPRO'+f"_{args.model_name}_fusion" + f"{args.extension}")
