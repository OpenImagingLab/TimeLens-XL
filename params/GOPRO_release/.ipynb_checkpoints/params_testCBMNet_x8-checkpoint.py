...
def GOPRO_release_CBMNet_testx8(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, 'GOPRO'+f"_{args.model_name}_testx8" + f"{args.extension}")
    ...
    validation_config.num_workers = 8 if hostname == 'server' else 1
