...
def trainGOPRO_REFIDx32(args):
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, 'GOPRO'+f"_{args.model_name}x32" + f"{args.extension}")
    ...
    params.validation_config.num_workers = 2
    return params
