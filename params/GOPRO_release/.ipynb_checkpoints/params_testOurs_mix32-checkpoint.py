...
def testGOPRO_Oursx32(args):
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, 'GOPRO'+f"_{args.model_name}mix32" + f"{args.extension}")
    ...
    validation_config.interp_ratio_val = 32
