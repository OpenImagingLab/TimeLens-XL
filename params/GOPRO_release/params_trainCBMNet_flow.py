...
def GOPRO_release_CBMNet_flow(args):
    paths = ED()
    ...
    paths.save = ED()
    paths.save.save_path = './RGB_GOPRO_release_tune'
    paths.save.exp_path = os.path.join(paths.save.save_path, 'GOPRO'+f"_{args.model_name}_flow" + f"{args.extension}")
    ...
    training_config.optim.scheduler_params.milestones = [1e10]
    ...
    validation_config.val_epochs = 40
    validation_config.val_imsave_epochs = 40
    ...
    validation_config.num_workers = 1 if hostname == 'server' else 1
