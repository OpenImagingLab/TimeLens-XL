...
def GOPRO_release_TimeLens_refine(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, 'GOPRO'+f"_{args.model_name}_refine" + f"{args.extension}")
    ...
    params.training_stage = 'warp_refine'
