...
def GOPRO_release_CBMNet_testx32(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, 'GOPRO'+f"_{args.model_name}_testx32" + f"{args.extension}")
    ...
    training_config.num_workers = 12 if hostname == 'server' else 1
    ...
    training_config.optim.scheduler_params.milestones = [1e5]
    ...
    validation_config.val_epochs = 20
    validation_config.val_imsave_epochs = 20
    ...
    validation_config.interp_ratio = 32
    ...
    validation_config.num_workers = 2 if hostname == 'server' else 1
