...
def Adobe_release_CBMNet_testx32(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, 'Adobe'+f"_{args.model_name}_testx32" + f"{args.extension}")
    ...
    validation_config.losses.dists.weight = 1.
    validation_config.losses.dists.as_loss = False
    validation_config.num_workers = 4
    params = ED()
    params.paths = paths
