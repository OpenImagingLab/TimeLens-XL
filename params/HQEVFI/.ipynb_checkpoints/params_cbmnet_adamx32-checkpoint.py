...
def cbmnet_RC_x32_adam(args):
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"_{args.model_name}x32" + f"_adam{args.extension}")
    ...
    training_config.interp_ratio = 32
