...
def cbmnet_RC_mix_adam(args):
    ...
    paths.save = ED()
    paths.save.save_path = './RGB_resOut_RC'
    ...
    training_config = ED()
    training_config.dataloader = 'loader_RC_timelens_mix'
    ...
    validation_config.dataloader = 'loader_RC_timelens_mix'
