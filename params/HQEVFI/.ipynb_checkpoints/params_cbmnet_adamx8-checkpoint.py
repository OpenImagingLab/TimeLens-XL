...
def cbmnet_RC_x8_adam(args):
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"_{args.model_name}x8" + f"_adam{args.extension}")
    ...
    training_config.optim.scheduler_params.milestones = [10]
