...
def traintest_RC_x32_lpips(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"_{args.model_name}x32" + f"_adamLPIPS{args.extension}")
    ...
    training_config = ED()
    training_config.dataloader = 'loader_RC'
    ...
    training_config.optim.scheduler_params.T_max = 80000
    ...
    validation_config.dataloader = 'loader_RC'
    ...
    validation_config.real_interp = 32
