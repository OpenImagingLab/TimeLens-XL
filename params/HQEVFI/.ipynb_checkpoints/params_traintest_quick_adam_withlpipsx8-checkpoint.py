...
def traintest_RC_x8_lpips(args):
    paths = ED()
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"_{args.model_name}x8" + f"_adamLPIPS{args.extension}")
    ...
    training_config = ED()
    training_config.dataloader = 'traintest_RC_mix_lpips'
    ...
    validation_config.dataloader = 'traintest_RC_mix_lpips'
