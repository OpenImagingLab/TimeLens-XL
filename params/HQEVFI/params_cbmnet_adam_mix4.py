...
def cbmnet_RC_smallmix_adamx4(args):
    paths = ED()
    interp_ratio = 4
    ...
    paths.save.exp_path = os.path.join(paths.save.save_path, f"mix_{args.model_name}x16" + f"_adam{args.extension}")
    ...
    paths.save.val_im_path = os.path.join(paths.save.exp_path, f'Validation_Visual_Examples_IR{interp_ratio}')
    ...
    training_config.interp_ratio = interp_ratio
    ...
    validation_config.interp_ratio = interp_ratio
    validation_config.real_interp = interp_ratio
