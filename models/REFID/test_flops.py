...
events = torch.randn(1, 15, 2, datashape_h, datashape_w).float().cuda()

macs, model_params = 0, 0

outprofile = profile(net, inputs=(left_frame, right_frame, events))
macs += outprofile[0]
