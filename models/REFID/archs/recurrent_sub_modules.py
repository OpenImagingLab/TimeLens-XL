...
from models.REFID.archs.dcn_util import ModulatedDeformConvPack
from models.REFID.archs.fusion_modules import CrossmodalAtten, CrossmodalAtten_imgeventalladd
...
class TransposeRecurrentFlowConvLayer(nn.Module):
    """
    for decoder
    ...
    def __init__(self, in_channels, out_channels, kernel_size=2, stride=2, padding=0, norm=None, fuse_two_direction=False):
        super(TransposeRecurrentFlowConvLayer, self).__init__()
...
class ConvResidualBlocks(nn.Module):
    ...
    def __init__(self, num_in_ch=3, num_out_ch=64, num_block=15):
        ...
        self.main = nn.Sequential(
            nn.Conv2d(num_in_ch, num_out_ch, 3, 1, 1, bias=True), nn.LeakyReLU(negative_slope=0.1, inplace=False),
