...
class EventInterpNet(nn.Module):
    ...
    def load_pretrain_network(self):
        ...
        weights = th.load(self.params.pretrained_weights_dict['FlowNet'])['model_state']
        ...
        print("/n/n/n/nCBMNet flow network weights loaded. Paramters are fixed")
        return
    ...
    def forward(self, batch, mode='joint'):
        if mode=='flow':
            ...
            print(len(output_clean), output_clean[0].shape)
            exit()
