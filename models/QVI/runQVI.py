...
from models.QVI.models.QVI import QVI
...
class QVI(BaseModel):
	def __init__(self, params):
		...
		model = QVI()
		weights = torch.load("./pretrained_weights/QVI.pt")["model_state_dict"]
		# state_dict = os.path.join(os.getcwd(), './pretrained_weights/QVI.pt')
